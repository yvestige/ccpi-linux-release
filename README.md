...
![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/cdfa6a48-56d3-4dba-8628-2b474f82fe69)
...
![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/62e1cec4-5a2f-4c4f-8b05-1fa3469dde16)
...
4. Animations per line are provided based on the context of current line. Notifications under the codes area button will also appear to provide further context. You can **use the pause button** at specific renderings to study their resulting diagrams and notifications.
   ...
   ![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/893d1174-8a86-495a-82ab-9c014ae9cd13)
   ...
   ![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/a694a5f2-c943-4195-8194-894c71e93573)

5. If you want to navigate to specific lines in the codes pane, provided that the animations are not on pause, you can **use the next or previous buttons**. You can either **click on them once** to flash forward or backward 1 line, or **hold the button** to continuously navigate at a specific direction. Alternatively, you can use the "**Go to line**" button to go to a specific line.    ![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/91922b83-9920-41ed-ae7a-9f01dc26d880)

   Take note, however, that you cannot move past an erroneous line in the animations even if there are more codes succeeding it.![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/3176f2be-2193-4dc6-a4a9-baf3f97166b1)
...
6. If you want to change something in the code, you cannot simply click on the codes area and modify the codes. You must click the "**Stop Execution**" button first to halt all animations and enable the code editing mode.
   ...
   ![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/446e5547-2d76-4169-8db7-db0c34cf7722)
...
7. If you want to save your current C pointer codes as a file which you can load in the future, you can use the "**Import as CPF File**" button. This will prompt you to save your current code as an external C-Pointer File (CPF) that you can save on your local computer. You can later load these files using the "**Import CPF Files/Sample Codes**" button. 
   ...
   ![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/d91fe2e7-42c7-40f0-b1d3-fe5801aa5dd0)
...
![image](https://github.com/yvestige/cpci-linux-release/blob/main/User%20Manual/assets/3de0e373-44fd-475f-a9b2-8cecc3d16b86)
